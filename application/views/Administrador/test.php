                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/AdminLTE/dist/img/user7-128x128.jpg');?>" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/AdminLTE/dist/img/user3-128x128.jpg');?>" alt="User Image">
              ...
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="product-img">
                    <img src="<?php echo base_url('assets/AdminLTE/dist/img/default-50x50.gif');?>" alt="Product Image">
                  </div>
